...
void UBluEye::ClearBLUICache(const FString& BluiCache)
{

	FPlatformFileManager::Get().GetPlatformFile().DeleteFile(*BluiCache);
	UE_LOG(LogBlu, Warning, TEXT("File have been Deleted"));
	return;
